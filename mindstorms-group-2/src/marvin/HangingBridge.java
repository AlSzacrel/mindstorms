...
public class HangingBridge implements Step {
    ...
    public void run(Configuration configuration) {
        ...
        if (followWallPart) {
            ...
            if (sensorDataCollector.isBright(light.getNormalizedLightValue()) || ultraSonic.getDistance() > NO_WALL) {
            ...
            followWall.followWall(movement, ultraSonic, configuration);
            ...
            followHangingBridge(sensorDataCollector, movement, light, ultraSonic);
    ...
    private void followHangingBridge(SensorDataCollector sensorDataCollector, MovementPrimitives movement,
            LightSensor light, UltrasonicSensor ultraSonic) {
