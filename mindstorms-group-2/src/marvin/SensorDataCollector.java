...
public class SensorDataCollector {
	...
	private static final float SENSOR_HEAD_SPEED_FACTOR = 0.5f;
	...
	public void collectData() {
		...
		sensorMotor.setSpeed(SENSOR_HEAD_SPEED_FACTOR
				* sensorMotor.getMaxSpeed());
	...
	private LineBorders scan(NXTRegulatedMotor sensorMotor) {
		...
		sensorMotor.stop();
		configuration.write("darkToBright: " + darkToBrightAngle
				+ " brightToDark: " + brightToDarkAngle + " lineWidth: "
				+ (brightToDarkAngle - darkToBrightAngle) + ";\r\n\r\n");
		return new LineBorders(darkToBrightAngle, brightToDarkAngle, minAngle,
				maxAngle);
	}
